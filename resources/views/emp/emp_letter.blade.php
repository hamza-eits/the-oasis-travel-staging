...
@endif
  ...
  @if (count($errors) > 0)
            ...
            @include('emp.emp_info')
                         ...
                         <form action="{{URL('/letter_issue_preview')}}" method="post"> {{csrf_field()}} 
   ...
   <table class="table table-sm m-0 table-striped"  >
           ...
           <tr>
     <td  class="text-center" > <input class="form-check-input  " type="radio" name="LetterID" id="formRadios1" checked="" value=" {{$value->LetterID}}"></td>
                <td scope="row"> 
...
<p class="card-title-desc"> </p>     
 ...
 <table class="table table-hover align-middle table-sm table-nowrap mb-0">
        ...
        <a href="{{URL('/issue_letter_edit/'.$value->IssueLetterID)}}" class="text-success"><i class="mdi mdi-pencil font-size-15"></i></a>
        <a href="{{URL('/issue_letter_print/'.$value->IssueLetterID)}}" class="text-secondary"><i class="mdi mdi-printer font-size-15"></i></a>
        <a href="#" onclick="delete_confirm2('issue_letter_delete',{{$value->IssueLetterID}})"    class="text-danger"><i class="mdi mdi-delete font-size-15"></i></a>
                                                             </div>
                                                        </td>
                                                    </tr>
