                      ...
                      <div class="mb-1 row">
                        ...
                        <div class="col-sm-9">
                          <select class="form-select changesNooo" name="InvoiceType1" id="InvoiceType1">
                            ...
                            <option value="{{$value->VoucherTypeID}}-{{$value->VoucherCode}}">
...
$(".addmore").on('click',function(){
  ...
  html += '<td><select name="ChOfAcc[]" id="ItemID0_'+i+'" class="form-select select2 changesNoo" required=""> <option value="">Select Account</option> @foreach ($chartofaccount as $key => $value) <option value="{{$value->ChartOfAccountID}}">{{$value->ChartOfAccountID}}-{{$value->ChartOfAccountName}}</option>@endforeach</select> </td>';
