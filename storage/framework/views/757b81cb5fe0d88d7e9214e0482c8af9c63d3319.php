 ...
 <div class="col-md-4 mt-2  mb-2 ">
        ...
        <!-- Date Fields -->
            ...
            <input type="date" id="StartDate" name="StartDate" placeholder="Start Date" class="form-control" value="<?php echo e(date('Y-m-01')); ?>">
 ...
 <div class="col-md-4  mb-2  mt-2">
            ...
            <input type="date" id="EndDate" name="EndDate" placeholder="End Date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
...
<?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/components/start_end_date.blade.php ENDPATH**/ ?>