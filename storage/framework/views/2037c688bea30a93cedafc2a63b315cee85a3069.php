        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Cashbook</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(URL('/CashbookReport1')); ?>" method="post" name="form1" id="form1"> 
...
<script>
  $(document).ready(function(){
    $('#pdf').click(function(event){
        ...
        $('#form1').attr('action', '<?php echo e(URL("/CashbookReport1PDF")); ?>');
        $('#form1').submit();
    });
    $('#online').click(function(event){
        event.preventDefault();
        $('#form1').removeAttr('target');
        $('#form1').attr('action', '<?php echo e(URL("/CashbookReport1")); ?>');
        $('#form1').submit();
    });
});
</script>
...
<?php echo $__env->make('tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/reports/cashbook_report.blade.php ENDPATH**/ ?>