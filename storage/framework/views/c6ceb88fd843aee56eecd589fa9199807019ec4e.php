                ...
                <table style="border-collapse: collapse;" cellspacing="0" cellpadding="0">
                  ...
                  <tbody>
                    ...
                    <tr class="bg-light border-1 border-light">
                      ...
                      <td> <select name="SupplierID[]" id="SupplierID_<?php echo e($no); ?>" class="  form-select supplier select2"
                          ...
                          <option value="<?php echo e($value->SupplierID); ?>" <?php echo e(($value->SupplierID== $value1->SupplierID) ?
                            'selected=selected':''); ?>><?php echo e($value->SupplierName); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                      ...
                      <td> <select name="PartyID[]" id="PartyID_<?php echo e($no); ?>" class=" form-select party select2"
                          ...
                          <option value="<?php echo e($value->PartyID); ?>" <?php echo e(($value->PartyID== $value1->PartyID) ?
                            'selected=selected':''); ?>><?php echo e($value->PartyID); ?>-<?php echo e($value->PartyName); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
<?php echo $__env->make('tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/voucher_edit.blade.php ENDPATH**/ ?>