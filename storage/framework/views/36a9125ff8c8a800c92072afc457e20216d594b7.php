...
<body onload="window.print();">
    ...
    <table width="100%" border="0" style="margin-top: 0px;">
        <tr>
            <th width="50%" scope="col" align="left" style="vertical-align: top;">
                <img src="<?php echo e(asset('documents/' . $company->Logo)); ?>" alt="" width="<?php echo e(env('APP_LOGO_WIDTH')); ?>"
                    height="<?php echo e(env('APP_LOGO_HEIGHT')); ?>">
            </th>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr style="color: white; ">
            ...
            <td align="center" bgcolor="#333333"><?php echo e(env('APP_TAX_NAME')); ?></p>
            </td>
        ...
        <?php $__currentLoopData = $invoice_det; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <td style="padding-top: 10px;"><?php echo e($value->ItemName); ?>

                    <?php if($value->PaxName): ?>
                        <br><strong>PAX:</strong> <?php echo e($value->PaxName); ?>

                    <?php endif; ?>

                    <?php if($value->PNR): ?>
                        <br><strong>PNR:</strong> <?php echo e($value->PNR); ?>

                    <?php endif; ?>

                    <?php if($value->Sector): ?>
                        <br><strong>Sector:</strong> <?php echo e($value->Sector); ?>

                    <?php endif; ?>

                    <?php if($value->Passport): ?>
                        <br><strong>Passport #:</strong> <?php echo e($value->Passport); ?>

                    <?php endif; ?>

                    <?php if($value->TicketNo): ?>
                        <br><strong>Ticket #:</strong> <?php echo e($value->TicketNo); ?>

                    <?php endif; ?>

                    

                    <?php if($value->DepartureDate): ?>
                        <br><strong>Departure Date:</strong> <?php echo e(dateformatman2($value->DepartureDate)); ?>
            ...
            <td colspan="2" width="49%">
                <table width="100%" border="0" align="right">
                    ...
                    <tr>
                        ...
                        <td height="25">
                            <strong><?php echo e(env('APP_CURRENCY')); ?><?php echo e(number_format($invoice_mst[0]->Total, 2)); ?></strong>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr style="background-color: #e9e9e9;">
                        ...
                        <td height="25"><strong><?php echo e(env('APP_CURRENCY')); ?>

                                <?php echo e(number_format($invoice_mst[0]->Balance, 2)); ?></strong></td>
                    </tr>
...
<?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/invoice_pdf.blade.php ENDPATH**/ ?>