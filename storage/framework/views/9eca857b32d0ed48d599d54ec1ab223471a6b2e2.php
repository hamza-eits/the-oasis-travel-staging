            ...
            <div class=" ">
              <div class=" ">
                ...
                <div class="row">
                  ...
                  <select name="PartyID" id="PartyID" class="form-select select2 mt-5" required></select>
                        ...
                        <tbody>
                          <tr class="p-3" style="vertical-align: top;">
                            ...
                            <td>
                              ...
                              <select name="ItemID0[]" id="ItemID0_1" class="form-select form-control-sm  select2 changesNoo" required >
                                ...
                                <option  value="<?php echo e($value->ItemID); ?>" data-tax="<?php echo e($value->Percentage); ?>">
                                  <?php echo e($value->ItemCode); ?>-<?php echo e($value->ItemName); ?>-<?php echo e($value->Percentage); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                              <select name="SupplierID[]" id="SupplierID_1" class="form-select select2 changesNo" required
                            ...
                            <td>
                              <input type="number" name="Fare[]" id="Fare_1" class=" form-control changesNo" required
                            ...
                            <td>
                              <input type="number" name="Taxable[]" id="Taxable_1" class=" form-control  changesNo  "
                                ...
                                autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;"
                                onpaste="return false;" step="0.01" placeholder="<?php echo e(env('APP_TAX_NAME')); ?> Amount ">
                            </td>
                            <td>
                            ...
                            <td class="d-none">
                              <input type="number" name="OPVAT[]" id="OPVAT_1" class=" form-control changesNo "
                                autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;"
                                onpaste="return false;" step="0.01">
                            </td>
                            <td class="d-none">
                              <input type="number" name="IPVAT[]" id="IPVAT_1" class=" form-control changesNo "
                                autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;"
                                onpaste="return false;" step="0.01">
                            </td>
                            ...
                            <td>
                              <input type="number" name="ItemTotal[]" id="total_1" required
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8 col-12  ">
                      ...
                      <div class="mt-2"><button type="submit" class="btn-disable btn btn-success w-lg float-right">Save</button>
...
var i = $('table tr').length;
    ...
    $(".addmore").on('click', function() {
        ...
        html += '<td><input type="text" required name="Fare[]" id="Fare_' + i + '" class="form-control" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" placeholder="Fare"></td>';
        html += '<td><input type="text" name="Taxable[]" id="Taxable_' + i + '" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"  placeholder="<?php echo e(env('APP_TAX_NAME')); ?> "><input type="text" name="TaxAmount[]" id="TaxAmount_' + i + '" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" placeholder="<?php echo e(env('APP_TAX_NAME')); ?> Amount "></td>';
        ...
        // html += '<td>tax</td>';
        // html += '<td>service</td>';
        html += '<td><input type="text" required name="ItemTotal[]" id="total_' + i + '" class="form-control totalLinePrice changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" placeholder="Total"></td>';
...
<?php echo $__env->make('tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/arsalan-travel/resources/views/invoice_create.blade.php ENDPATH**/ ?>