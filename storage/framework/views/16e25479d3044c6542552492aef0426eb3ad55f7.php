...
<script>
       function delete_voucher(id) {        
        ...
        url = '<?php echo e(URL::TO('/')); ?>/VoucherDelete/'+ id;
                                    ...
                                    <h4 class="mb-sm-0 font-size-18">Voucher</h4>
                                       ...
                                       <div class="btn-group  shadow-sm dropstart">
                                                ...
                                                <div class="dropdown-menu" style="margin: 0px;">
                                                    <a class="dropdown-item" href="<?php echo e(URL('/VoucherCreate/BP')); ?>">BP-Bank Payment</a>
                                                    <a class="dropdown-item" href="<?php echo e(URL('/VoucherCreate/BR')); ?>">BR-Bank Receipt</a>
                                                     <div class="dropdown-divider"></div>
                                                     <a class="dropdown-item" href="<?php echo e(URL('/VoucherCreate/CP')); ?>">CP-Cash Payment</a>
                                                      <a class="dropdown-item" href="<?php echo e(URL('/VoucherCreate/CR')); ?>">CR-Cash Receipt</a>
                                                        <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" href="<?php echo e(URL('/JV')); ?>">Journal Voucher</a>
                                                </div>
                                            </div>
                                    </div>  
...
$(document).ready(function() {
     // Initialize DataTable with filter parameters
        ...
        "serverSide": true,
         "ajax": {
            "url": "<?php echo e(url('ajax_voucher')); ?>",
            "data": function (d) {
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/voucher.blade.php ENDPATH**/ ?>