...
<form action="<?php echo e(URL('/PettyCashSave')); ?>" method="post"> 
...
<div class="clearfix mt-1"></div>
    ...
    <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <div id="vhno_div"> <img src="<?php echo e(asset('assets/images/ajax.gif')); ?>" alt="">
                     </div>
                  </div>
                </div>
              </div>
  ...
  <input type="text" name="ToDate"  autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="<?php echo e(date('Y-m-d')); ?>">
...
<div class="card-footer bg-light"> <div  ><button type="submit" id="submit" class="btn btn-primary w-lg float-right">Save</button>
  <a href="<?php echo e(URL('/PettyCash')); ?>"   class="btn btn-secondary w-md float-right">Cancel</a>
...
$(".addmore").on('click',function(){
  ...
  html += '<td><select name="ChartOfAcc2[]" id="ItemID0_'+i+'" class="form-select form-control-sm   "><?php $__currentLoopData = $chartofaccount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>         <option value="<?php echo e($value->ChartOfAccountID); ?>"><?php echo e($value->ChartOfAccountID); ?>-<?php echo e($value->ChartOfAccountName); ?></option>  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>       </select></td>';
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/bin_javed_pk/resources/views/pettycash_create.blade.php ENDPATH**/ ?>