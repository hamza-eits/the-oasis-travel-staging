    ...
    <div class="page-content">
        <div class="container-fluid">
            <!-- start page title -->
             ...
             <form action="<?php echo e(URL('/EstimateSave')); ?>" method="post">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="EstimateNo" autocomplete="off" class="form-control" value="EST-<?php echo e($estimate_master[0]->EstimateNo); ?>">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" id="datepicker21">
                                                <input type="text" name="Date" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="<?php echo e(date('Y-m-d')); ?>">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" id="datepicker22">
                                                <input type="text" name="DueDate" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker22" data-provide="datepicker" data-date-autoclose="true" value="<?php echo e(date('Y-m-d')); ?>">
                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-8 col-12  ">
                                ...
                                <textarea class="form-control" rows='5' name="DescriptionNotes" id="note" placeholder="Description notes if any."></textarea>
                                                        ...
                                                        <br>
                               <!--  <iframe src="<?php echo e(URL('/Attachment')); ?>" width="100%" height="40%" border="0" scrolling="yes" style="overflow: hidden;"></iframe> -->

                                <div class="mt-2"><button type="submit" class="btn btn-success w-md float-right">Save</button>
                                    <a href="<?php echo e(URL('/DeliveryChallan')); ?>" class="btn btn-secondary w-md float-right">Cancel</a>
...
<script src="<?php echo e(asset('assets/js/myapp.js')); ?>" type="text/javascript"></script>

<!-- END: Content-->

<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/bin_javed_pk/resources/views/estimate/estimate_create.blade.php ENDPATH**/ ?>