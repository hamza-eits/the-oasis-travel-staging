...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="<?php echo e(URL('/ExpenseUpdate')); ?>" method="post">

<input type="hidden" name="ExpenseMasterID" value="<?php echo e($expense_master[0]->ExpenseMasterID); ?>">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="SupplierID" id="SupplierID" class="form-select select2 mt-5"  required="">
                                            ...
                                            <?php foreach ($supplier as $key => $value) : ?>
                                                <option value="<?php echo e($value->SupplierID); ?>" <?php echo e(($value->SupplierID== $expense_master[0]->SupplierID) ? 'selected=selected':''); ?>><?php echo e($value->SupplierName); ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                         <select name="ChartOfAccountID_From" id="ChartOfAccountID_From" class="form-select form-control-sm select2   " style="width: 100% !important;">
                                                    ...
                                                    <option value="<?php echo e($value->ChartOfAccountID); ?>" <?php echo e(($value->ChartOfAccountID== $expense_master[0]->ChartOfAccountID) ? 'selected=selected':''); ?>><?php echo e($value->ChartOfAccountID); ?>-<?php echo e($value->ChartOfAccountName); ?></option>
                                  ...
                                  <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ReferenceNo" autocomplete="off" class="form-control" value="<?php echo e($expense_master[0]->ReferenceNo); ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div id="invoict_type"> <input type="text" name="ExpenseNo" autocomplete="off" class="form-control" value="<?php echo e($expense_master[0]->ExpenseNo); ?>" readonly=""></div>
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" id="datepicker21">
                                                <input type="text" name="Date" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="<?php echo e($expense_master[0]->Date); ?>">
                        ...
                        <div class='row'>
                            <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                <table>
                                    ...
                                    <tbody>
                                   <?php $__currentLoopData = $expense_detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $value1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                   <?php $no = $key + 1; ?>
                                        <tr class="p-3">
                                            ...
                                            <td>
                                                ...
                                                <select name="ItemID0[]" id="ItemID0_<?php echo e($no); ?>" class="item form-select form-control-sm select2   changesNoo " onchange="km(this.value,<?php echo $no; ?>);" style="width: 300px !important;">
                                                    <option value="">select</option>
                                                    <?php $__currentLoopData = $chartofaccount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                    <option value="<?php echo e($value->ChartOfAccountID); ?>" <?php echo e(($value->ChartOfAccountID== $value1->ChartOfAccountID) ? 'selected=selected':''); ?>><?php echo e($value->ChartOfAccountID); ?>-<?php echo e($value->ChartOfAccountName); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <input type="hidden" name="ChartOfAccountID[]" id="ItemID_<?php echo e($no); ?>" value="<?php echo e($value1->ChartOfAccountID); ?>">
                                            </td>


                                            <td>
                                                <input type="text" name="Description[]" id="Description_<?php echo e($no); ?>" class=" form-control " value="<?php echo e($value1->Notes); ?>">
                                            </td>

                                                 <td>
                                                <select name="Tax[]" id="TaxID_1" class="form-select changesNo" required="">
                                                    <?php foreach ($tax as $key => $valueX1) : ?>
                                                        <option value="<?php echo e($valueX1->TaxPer); ?>" <?php echo e(($valueX1->TaxPer== $value1->TaxPer) ? 'selected=selected':''); ?>><?php echo e($valueX1->Description); ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                            </td>
                                              ...
                                              <td >
                                                <input type="number" name="Amount[]" id="Amount_1" class=" form-control changesNo exclusive" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="<?php echo e($value1->Amount); ?>" required="">
                                            </td>
                                                    ...
                                                    <td>
                                                <input type="number" name="TaxVal[]" id="TaxVal_1" class=" form-control totalLinePrice2 tax changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" required="" value="<?php echo e($value1->Tax); ?>">
                                            </td>

                                            <td>
                                                <input type="number" name="AmountAfterTax[]" id="AmountAfterTax_1" class=" form-control totalLinePrice  changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" required="" value="<?php echo e($value1->AmountAfterTax); ?>">
                                            </td>
                                        </tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-8 col-12  ">
                                ...
                                <div class="mt-2"><button type="submit" class="btn btn-success w-md float-right">Save</button>
                                    <a href="<?php echo e(URL('/Expense')); ?>" class="btn btn-secondary w-md float-right">Cancel</a>
                                    <a href="<?php echo e(URL('/Attachment'.'/'.$expense_master[0]->ExpenseNo)); ?>" class="modal-link btn btn-success">Attach file</a>
                                ...
                                <form class="form-inline">
                                      ...
                                      <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light"><?php echo e(session::get('Currency')); ?></span>

                                            <input type="text" class="form-control" id="subTotal" name="SubTotal" placeholder="Subtotal" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="<?php echo e($expense_master[0]->SubTotal); ?>" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="grandtotaltax" name="grandtotaltax" placeholder="Subtotal" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="<?php echo e($expense_master[0]->Tax); ?>" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light"><?php echo e(session::get('Currency')); ?></span>
                                            <input type="number" name="Grandtotal" class="form-control" step="0.01" id="grandtotal" placeholder="Grand Total" readonly onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="<?php echo e($expense_master[0]->GrantTotal); ?>" required="">
                                        </div>
                                    </div>
...
<script>
    ...
    $(".addmore").on('click', function() {
        ...
        html += '<td><select name="ItemID0[]" id="ItemID0_' + i + '"  style="width: 300px !important;" class="form-select select2 changesNoo" onchange="km(this.value,' + i + ');" required=""> <option value="">select</option>}<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($value->ChartOfAccountID); ?>|<?php echo e($value->ChartOfAccountName); ?>"><?php echo e($value->ChartOfAccountID); ?>-<?php echo e($value->ChartOfAccountName); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select><input type="hidden" name="ChartOfAccountID[]" id="ItemID_' + i + '"></td>';
        ...
        html += '<td><select name="Tax[]" id="TaxID_' + i + '" class="form-select changesNo"><?php foreach ($tax as $key => $valueX1) : ?><option value="<?php echo e($valueX1->TaxPer); ?>"><?php echo e($valueX1->Description); ?></option><?php endforeach ?></select></td>';
    ...
    $(document).on('change keyup blur ', '.changesNo', function() {
        ...
        TotalVal = ( (parseFloat(TaxPer) / 100) * parseFloat(Amount) ).toFixed(2);


 


         $('#TaxVal_' + id[1]).val(TotalVal);



        AmountAfterTax = parseFloat(TotalVal) + parseFloat(Amount);

         $('#AmountAfterTax_' + id[1]).val(AmountAfterTax);
  ...
  calculateTotal();
    ...
    function calculateTotal() {
        ...
        console.log(grandtotaltax);
           ...
           $('#grandtotal').val(subTotal+grandtotaltax);
...
<!-- <script src="<?php echo e(asset('assets/js/jquery-3.6.0.js')); ?>" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script> -->
...
<script>
    function ajax_balance(SupplierID) {
        ...
        $('#result').prepend('')
        $('#result').prepend('<img id="theImg" src="<?php echo e(asset('
    ...
    $("#InvoiceType").change(function() {
        ...
        if (InvoiceType != "") {
            ...
            $.ajax({
                ...
                url: "<?php echo e(URL('/ajax_invoice_vhno')); ?>",
                type: "POST",
                data: {
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/bin_javed_pk/resources/views/expense/expense_edit.blade.php ENDPATH**/ ?>