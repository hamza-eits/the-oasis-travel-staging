    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <form action="<?php echo e(URL('/JVSave')); ?>" method="post">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    ...
                    <textarea name="Narration_mst" id="Narration" cols="30" rows="5" class="form-control " required=""
                  ...
                  <div class="col-6">
                      ...
                      <div class="mb-1 row">
                        ...
                        <div class="col-sm-9">
                          <select class="form-select changesNooo" name="InvoiceType1" id="InvoiceType1">
                            ...
                            <option value="<?php echo e($value->VoucherTypeID); ?>-<?php echo e($value->VoucherCode); ?>">
                    ...
                    <div class="col-12 d-none">
                      <div class="mb-1 row">
                        ...
                        <div class="col-sm-9">
                          <select class="form-select select2 changesNooo" name="InvoiceType1" id="InvoiceType1">
                  ...
                  <table style="border-collapse: collapse;" cellspacing="0" cellpadding="0">
                    <thead>
                      <tr class="bg-light borde-1 border-light " style="height: 40px;">
                        <th width="2%" class="p-1"><input id="check_all" type="checkbox" style="margin-left: 13px;" />
                        </th>
                    ...
                    <tbody>
                      <tr class="bg-light border-1 border-light">
                        ...
                        <td> <select name="SupplierID[]" id="SupplierID_1" class="   form-select select2"
                        ...
                        <td> <select name="PartyID[]" id="PartyID_1" class="  select2 form-select "
                            onchange="ajax_balance(this.value);">
                            ...
                            <option value="<?php echo e($value->PartyID); ?>"><?php echo e($value->PartyID); ?>-<?php echo e($value->PartyName); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </select>
                        ...
                        <td>
                          <input type="text" name="Narration[]" id="RefNo_1" class="form-control      " required=""
                            autocomplete="off">
                        </td>
                        ...
                        <td>
                          <input type="number" name="Debit[]" id="debit_1"
                        ...
                        <td>
                          <input type="number" name="Credit[]" id="credit_1"
                      ...
                      <tr class="bg-light border-1 border-light">
                        ...
                        <td>
                          ...
                          <select name="ChOfAcc[]" id="ItemID0_2" class="select2 form-select form-control-sm   " required="">
                            <option value="">Select Account</option>
                            <?php $__currentLoopData = $chartofaccount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($value->ChartOfAccountID); ?>">
                              <?php echo e($value->ChartOfAccountID); ?>-<?php echo e($value->ChartOfAccountName); ?></option>
                        ...
                        <td> <select name="SupplierID[]" id="SupplierID_2" class=" select2 supplier form-select "
                            onchange="ajax_balance(this.value);">
                            <option value="">Select Supplier</option>
                        ...
                        <td> <select name="PartyID[]" id="PartyID_2" class=" select2 party form-select "
                            onchange="ajax_balance(this.value);">
                            <option value="">Select PartyID</option>
                        ...
                        <td>
                          <input type="text" name="Narration[]" id="RefNo_2" class="form-control      " required="" autocomplete="off">
                        </td>
                        ...
                        <td>
                          <input type="number" name="Debit[]" id="debit_2"
                            class=" form-control changesNo totalLinePricee" autocomplete="off"
                            onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"
                            step="0.01">
                        </td>
                        <td>
                          <input type="number" name="Credit[]" id="credit_2"
                            class=" form-control changesNo totalLinePrice" autocomplete="off"
                            onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"
                            step="0.01">
                        </td>
      ...
      <div class="card-footer bg-light">
        <div><button type="submit" id="submit" class="btn btn-primary w-lg me-50 float-right">Save</button>
...
$(".addmore").on('click',function(){
  ...
  html += '<td><select name="SupplierID[]" id="SupplierID_'+i+'"  onchange="ajax_balance(this.value);" class="form-select supplier select2"> <option value="">Select Supplier</option><?php $__currentLoopData = $supplier; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($value->SupplierID); ?>"><?php echo e($value->SupplierName); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td>';
...
<script>
$(document).ready(function() {
    // When the SupplierID dropdown changes
    $('#SupplierID_1').on('change', function() {
        
            $('#ItemID0_1').val('210100').trigger('change.select2');
         
    });

    // When the PartyID dropdown changes
    $('#PartyID_1').on('change', function() {
        
        
        
            $('#ItemID0_1').val('110400').trigger('change.select2');
...
<?php echo $__env->make('tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/jv_create.blade.php ENDPATH**/ ?>