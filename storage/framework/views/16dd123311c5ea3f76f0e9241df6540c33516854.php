...
<div class="row">
  <div class="col-6"> <img src="<?php echo e(asset('assets/images/logo/ft.png')); ?>" alt="">
    ...
    <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="first-name" class="form-control" name="VHNO" value="<?php echo e($vhno[0]->VHNO); ?>" >
                  </div>
                </div>
              </div>
              <div class="col-12">
          ...
          <tbody>
            ...
            <tr class="p-3">
              ...
              <td>
                 ...
                 <select name="ItemID0[]" id="ItemID0_<?php echo e($no); ?>" class="form-select form-control-sm   changesNoo">
                  <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    <option value="<?php echo e($value->ItemID); ?>|<?php echo e($value->Percentage); ?>" <?php echo e(($value->ItemID== $value1->ItemID) ? 'selected=selected':''); ?> ><?php echo e($value->ItemCode); ?>-<?php echo e($value->ItemName); ?>-<?php echo e($value->Percentage); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                 </select>
                 <input type="hidden" name="ItemID[]" id="ItemID_<?php echo e($no); ?>" value="<?php echo e($value1->ItemID); ?>">
              </td>
              <td> <select name="SupplierID[]" id="SupplierID_<?php echo e($no); ?>" class=" form-select changesNo" onchange="ajax_balance(this.value);">
...
<?php echo $__env->make('tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/invoice_refund.blade.php ENDPATH**/ ?>