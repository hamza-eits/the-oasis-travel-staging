...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="<?php echo e(URL('/ExpenseSave')); ?>" method="post" class="custom-validation">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                         <select name="ChartOfAccountID_From" id="ChartOfAccountID_From" class="form-select form-control-sm select2   " style="width: 100% !important;" required="">
                                                    <option value="">select</option>
                                                    <?php $__currentLoopData = $chartofaccont; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="mb-1 row d-none">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <?php foreach ($tax as $key => $valueX1) : ?>
                                                        <option value="<?php echo e($valueX1->TaxPer); ?>"><?php echo e($valueX1->Description); ?></option>
                                                    <?php endforeach ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div id="invoict_type"> <input type="text" name="ExpenseNo" autocomplete="off" class="form-control" value="EXP-<?php echo e($vhno[0]->VHNO); ?>" required=""></div>
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" id="datepicker21">
                                                <input type="text" name="Date" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="<?php echo e(date('Y-m-d')); ?>" required="">
 ...
 <a href="<?php echo e(URL('/Attachment'.'/'.'EXP-'.$vhno[0]->VHNO)); ?>" class="modal-link btn btn-success">Attach file</a>
                                </div>
...
<script>
    ...
    $(".addmore").on('click', function() {
        ...
        // var data=<?php //echo $item; 
                    ?>
        // // var data=JSON.parse(<?php echo e($item); ?>);
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/expense/expensecreate.blade.php ENDPATH**/ ?>