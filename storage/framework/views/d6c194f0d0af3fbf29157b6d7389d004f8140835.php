...
<div class="card">
            <div class="card-body">
              <form action="<?php echo e(URL('/SaveCompany')); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <table class="table  m-0" id="student_table">
                      ...
                      <?php $__currentLoopData = $company; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td scope="row"><?php echo e($data->Name); ?> <?php echo e($data->Name2); ?></td>
                          <td><?php echo e($data->Contact); ?><br><?php echo e($data->Mobile); ?></td>
                          <td scope="row"><?php echo e($data->Email); ?></td>
                          <td><?php echo e($data->Address); ?></td>
                          <td><a href="<?php echo e(URL('/documents/' . $data->Logo)); ?>" class="text-dark fw-medium" target="_blank"><i class="mdi mdi-file-document font-size-16 align-middle text-primary me-2"></i>
                                                        </a>
                          </td>                          
                          <td><a href="<?php echo e(URL('/documents/' . $data->BackgroundLogo)); ?>" target="_blank" class="text-dark fw-medium" ><i class="mdi mdi-file-document font-size-16 align-middle text-primary me-2"></i>
                                                        </a>

                                                        
                          </td> 
                          <td><a href="<?php echo e(URL('/documents/' . $data->Signature)); ?>" target="_blank" class="text-dark fw-medium" ><i class="mdi mdi-file-document font-size-16 align-middle text-primary me-2"></i>
                                                        </a>
                          </td>                          
                          <td>
                            <div class="d-flex gap-1">
                              <a href="<?php echo e(URL('/CompanyEdit/'.$data->CompanyID)); ?>" class="text-secondary"  ><i class="mdi mdi-pencil font-size-15"></i></a>
                              <!-- <a href="#" class="text-secondary" onclick="delete_confirm2('CompanyDelete',<?php echo e($data->CompanyID); ?>)"><i class="mdi mdi-delete font-size-15"></i></a>
                             -->
                            </div>
                          </td>
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/company/company.blade.php ENDPATH**/ ?>