    ...
    <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="first-name" class="form-control" name="VHNO" value="<?php echo e($invoice_mst[0]->InvoiceMasterID); ?>" >
                  </div>
                </div>
              </div>
              <div class="col-12">
              ...
              <input type="hidden"  name="PaymentMode"  vlaue="<?php echo e($invoice_mst[0]->PaymentMode); ?>">
          ...
          <tbody>
            ...
            <tr class="p-3">
              ...
              <td>
                 ...
                 <select name="ItemID0[]" id="ItemID0_<?php echo e($no); ?>" class="form-select select2 form-control-sm   changesNoo" style="width:200px">
                  <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    <option value="<?php echo e($value->ItemID); ?>" data-tax="<?php echo e($value->Percentage ?? 0); ?>" <?php echo e(($value->ItemID== $value1->ItemID) ? 'selected=selected':''); ?>  ><?php echo e($value->ItemCode); ?>-<?php echo e($value->ItemName); ?>-<?php echo e($value->Percentage); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                 </select>
                 
              </td>
              <td> <select name="SupplierID[]" id="SupplierID_<?php echo e($no); ?>" class=" form-select select2 changesNo" onchange="ajax_balance(this.value);" style="width:200px">
              ...
              <?php
                  $taxPercentage = 0;
                  if($value1->Service > 0){
                    $taxPercentage = round(($value1->Taxable/$value1->Service)*100,2);
                  }

              ?>
              <td>
                <input type="number" name="Taxable[]"  id="Taxable_<?php echo e($no); ?>" class=" form-control  changesNo " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="<?php echo e($taxPercentage); ?>" >
              </td>
              <td>
              ...
              <td class="d-none">
                <input type="number" name="OPVAT[]" id="OPVAT_<?php echo e($no); ?>" class=" form-control " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="<?php echo e($value1->OPVAT); ?>">
              </td>
              <td class="d-none">
                <input type="number" name="IPVAT[]" id="IPVAT_<?php echo e($no); ?>" class=" form-control " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="<?php echo e($value1->IPVAT); ?>">
              </td>
              ...
              <td>
                <input type="number" name="ItemTotal[]" id="total_<?php echo e($no); ?>" class=" form-control totalLinePrice changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="<?php echo e($value1->Total); ?>">
              </td>
            </tr>
...
<span class="input-group-text bg-light"><?php echo e(env('APP_CURRENCY')); ?> </span>              
              <input type="number" name="Total" class="form-control" step="0.01" id="totalAftertax" placeholder="Total" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="<?php echo e($invoice_mst[0]->Total); ?>">
            </div>
          </div>
          ...
          <div class="form-group mt-1">
            ...
            <div class="input-group">
<span class="input-group-text bg-light"><?php echo e(env('APP_CURRENCY')); ?> </span>              
              <input readonly type="number" class="form-control" id="amountPaid-"  name="amountPaid" placeholder="Amount Paid" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="<?php echo e($invoice_mst[0]->Paid); ?>"> 
            </div>
          </div>
          ...
          <div class="form-group mt-1">
            ...
            <div class="input-group">
<span class="input-group-text bg-light"><?php echo e(env('APP_CURRENCY')); ?> </span>              
              <input type="number" class="form-control amountDue" name="amountDue"  id="amountDue" placeholder="Amount Due" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="<?php echo e($invoice_mst[0]->Balance); ?>"> 
            </div>
          </div>
                    
          <div class="form-group mt-1">
            
            <label><H5>Voucher: &nbsp;</H5></label>
            <div class="input-group">
<span class="input-group-text bg-light">VHNO</span>              
              <input  readonly type="text" class="form-control" name="Voucher"  placeholder="Voucher" value="<?php echo e($invoice_mst[0]->Voucher); ?>"> 
            </div>
          </div>
...
$(".addmore").on('click',function(){
  ...
  html += '<td><select name="ItemID0[]" id="ItemID0_'+i+'" class="form-select select2 changesNoo"> <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($value->ItemID); ?>" data-tax="<?php echo e($value->Percentage ?? 0); ?>"><?php echo e($value->ItemCode); ?>-<?php echo e($value->ItemName); ?>-<?php echo e($value->Percentage); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td>';
  ...
  html += '<td><input type="text" name="Taxable[]" id="Taxable_'+i+'" class="form-control changesNo   " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value=""></td>';
...
<?php echo $__env->make('tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/arsalan-travel/resources/views/invoice_edit.blade.php ENDPATH**/ ?>