...
<form action="<?php echo e(URL('/AdjustmentBalanceSave')); ?>" method="post"> 
...
<div class="col-6">
  ...
  <input type="text" name="VHDate"  id="VHDate" autocomplete="off" class="form-control kashif" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker22" data-provide="datepicker" data-date-autoclose="true" value="<?php echo e(date('Y-m-d')); ?>">
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/adjust_balance.blade.php ENDPATH**/ ?>