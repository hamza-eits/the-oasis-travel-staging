            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Umrah</h4>
                        <a href="<?php echo e(URL('/UmrahCreate')); ?>" class="btn btn-primary w-md float-right "><i
...
$item = DB::table('item')->whereIn('ItemCode',['UB','UA'])->get();
 ?>
...
<script>
     $(document).ready(function() {
            ...
            <?php if(session('invoiceMasterID')): ?>
                openInvoiceModal(<?php echo e(session('invoiceMasterID')); ?>,1);
            <?php endif; ?>
        });
</script>
<script>
    function openInvoiceModal(invoiceMasterID,idddd) {
       
        // alert(invoiceMasterID+'-'+idddd);
        // Fetch the invoice data using AJAX
        $.ajax({
            url: '<?php echo e(url("get_specific_invoice1")); ?>/' + invoiceMasterID,
            method: 'GET',
            success: function(response) {
                ...
                // Remove existing classes and add the new class based on the InvoiceTypeID
                    if(response.InvoiceTypeID === 3) {
                        $('#invoiceType').removeClass('bg-danger').addClass('bg-success');
                    } else if(response.InvoiceTypeID === 5) {
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/umrah/umrah.blade.php ENDPATH**/ ?>