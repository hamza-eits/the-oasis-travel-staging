        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <a href="<?php echo e(URL('/Umrah')); ?>" class="waves-effect">
          ...
          <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li> <a href="<?php echo e(URL('/AdminDashboard')); ?>" key="t-products">CRM Dashboard</a></li>
                        <li> <a href="<?php echo e(URL('/leads')); ?>" key="t-products">Leads</a></li>
 ...
 <li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li> <a href="<?php echo e(URL('/Supplier')); ?>" key="t-products"> Supplier</a></li>
                        <li> <a href="<?php echo e(URL('/User')); ?>" key="t-products"> User</a></li>
                        <!-- <li> <a href="<?php echo e(URL('/Salesman')); ?>" key="t-products"> Salesman</a></li> -->
...
<!--                         <li> <a href="<?php echo e(URL('/User')); ?>" key="t-products">Staff</a></li>
 -->                        <!-- <li>  <a   href="<?php echo e(URL('/')); ?>" key="t-products" >Recurring Bills</a></li> -->
...
</div><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/template/sidebar.blade.php ENDPATH**/ ?>