    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="<?php echo e(URL('/TrialBalance1')); ?>" method="post" name="form1" id="form1"> <?php echo e(csrf_field()); ?>
...
<script>
  $(document).ready(function(){
    $('#pdf').click(function(event){
        ...
        $('#form1').attr('action', '<?php echo e(URL("/TrialBalance1PDF")); ?>');
        $('#form1').submit();
    });
    $('#online').click(function(event){
        event.preventDefault();
        $('#form1').removeAttr('target');
        $('#form1').attr('action', '<?php echo e(URL("/TrialBalance1")); ?>');
        $('#form1').submit();
    });
});
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/the-oasis-travels/resources/views/reports/trial_balance.blade.php ENDPATH**/ ?>