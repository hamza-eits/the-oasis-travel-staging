<?php $__env->startSection('title', 'Sub Service Index'); ?>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e(isset($item->service) ? $item->service->name : 'N/A'); ?></td>
                                                <td>
                                                    <a href="#" onclick="edit_service(<?php echo e($item->id); ?>)">
                                                        <i class="mdi mdi-pencil  font-size-18 align-middle text-secondary"></i>
                                                    </a>
                                                    <a href="#"
                                                        onclick="delete_confirm_n(`subServiceDelete`,'<?php echo e($item->id); ?>')">
        ...
        <div class="modal fade exampleModal" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('subService.store')); ?>" method="post">
                        <?php echo csrf_field(); ?>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('subService.update')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="modal-body">
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/bin_javed_pk/resources/views/subservices/index.blade.php ENDPATH**/ ?>