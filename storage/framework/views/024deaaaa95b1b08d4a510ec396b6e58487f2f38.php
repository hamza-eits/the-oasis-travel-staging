  ...
  <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-print-block d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Statuses List List</h4>
...
<?php endif; ?>
 ...
 <?php if(count($errors) > 0): ?>
            ...
            <?php endif; ?>
                    ...
                    <div class="card-body">
                                <table id="status-table" class="table table-sm table-hover w-100">
                                    <thead >
                                        <tr>
                                            <th width="5%">#</th>
                                            <th width="90%">Name</th>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" onclick="edit_status(<?php echo e($item->id); ?>)">
                                                        <i class="mdi mdi-pencil  font-size-18 align-middle text-secondary"></i>
                                                    </a>
                                                    <a href="#"
                                                        onclick="delete_confirm_n(`statusDelete`,'<?php echo e($item->id); ?>')">
                ...
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('status.store')); ?>" method="post">
                        ...
                        <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <label for=""><strong>Status Name: *</strong></label>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('status.update')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="updateName" name="name"
                                                required>
                                            <input type="hidden" name="status_id" id="update_status_id">
                                        </div>
                                    </div>
        ...
        function edit_status(id) {
            $.ajax({
                ...
                success: function(response) {
                    if (response.data) {
                        $('#update_status_id').val(response.data.id);
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/bin_javed_pk/resources/views/statuses/index.blade.php ENDPATH**/ ?>