...
<input type="hidden" name="InvoiceMasterID" value="<?php echo e(request()->id); ?>">
   ...
   <?php foreach ($invoice_type as $key => $value): ?>
     <option value="<?php echo e($value->InvoiceTypeID); ?>" <?php echo e(($value->InvoiceTypeID== $invoice_mst[0]->InvoiceTypeID) ? 'selected=selected':''); ?>><?php echo e($value->InvoiceTypeCode); ?>-<?php echo e($value->InvoiceType); ?></option>
   <?php endforeach ?>
</select> 
 ...
 <?php foreach ($party as $key => $value): ?>
     <option value="<?php echo e($value->PartyID); ?>" <?php echo e(($value->PartyID== $invoice_mst[0]->PartyID) ? 'selected=selected':''); ?>><?php echo e($value->PartyID); ?>-<?php echo e($value->PartyName); ?>-<?php echo e($value->Phone); ?></option>
   <?php endforeach ?>
</select>
                   ...
                   <div class="col-12">
                        <div class="mb-1 row">
                          ...
                          <input type="text" id="first-name" class="form-control" name="VHNO"
                              value="<?php echo e($invoice_mst[0]->InvoiceMasterID); ?>" readonly="">
                        ...
                        <div class="mb-1 row">
                          ...
                          <div class="col-sm-9">
                            <div class="input-group" id="datepicker21">
                              <input type="date" name="Date" class="form-control" value="<?php echo e($invoice_mst[0]->Date); ?>">
                          ...
                          <div class="mb-1 row">
                            ...
                            <div class="col-sm-9">
                              <div class="input-group" id="datepicker22">
                               ...
                               <input type="date" name="DueDate" class="form-control" value="<?php echo e($invoice_mst[0]->DueDate); ?>">
                  ...
                  <?php foreach ($saleman as $key => $value): ?>
                    ...
                    <option value="<?php echo e($value->UserID); ?>" <?php echo e(($value->UserID== $invoice_mst[0]->UserID) ? 'selected=selected':''); ?>><?php echo e($value->FullName); ?></option>
                  <?php endforeach ?>
   ...
   <?php $__currentLoopData = $invoice_det; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $no= $key+1; ?>
                          ...
                          <tr class="bg-light borde-1 border-light " style="height: 40px;" id="t_<?php echo e($no); ?>">
                        ...
                        <tbody>
                          <tr class="p-3" style="vertical-align: top;" id="tt_<?php echo e($no); ?>">
                            <td class="p-1 bg-light borde-1 border-light"><input class="case" type="checkbox"  id="<?php echo e($no); ?>" /></td>
                            <td>

                               <select name="ItemID[]" id="ItemID_<?php echo e($no); ?>" class="form-select form-control-sm  select2 changesNoo"   >
                    ...
                    <option value="<?php echo e($value->ItemID); ?>" <?php echo e(($value->ItemID== $value1->ItemID) ? 'selected=selected':''); ?> ><?php echo e($value->ItemCode); ?>-<?php echo e($value->ItemName); ?>-<?php echo e($value->Percentage); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                             
                             </td>
                            <td>
                              <input type="text" name="PaxName[]" id="PaxName_<?php echo e($no); ?>" class=" form-control text-uppercase "
                                autocomplete="off" placeholder="PaxName" value="<?php echo e($value1->PaxName); ?>">

                               
                            </td>
                            <td>
                               <select name="PickPoint[]" id="PickPoint_<?php echo e($no); ?>" class="form-select">
                                  ...
                                  <?php $__currentLoopData = $pickpoint; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($item->name); ?>" <?php echo e(($item->name == $value1->PickPoint) ? 'selected=selected' : ''); ?>><?php echo e($item->name); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td>
                                <select name="VisaType[]" id="VisaType_<?php echo e($no); ?>" class="form-select">
                                  <option value="Multi" <?php echo e(('Multi'== $value1->VisaType) ? 'selected=selected':''); ?>>Multi</option>
                                  <option value="Umrah" <?php echo e(('Umrah'== $value1->VisaType) ? 'selected=selected':''); ?>>Umrah</option>
                                </select>

                               
                            </td>
                            <td>
                              <input type="number" name="Fare[]" id="Fare_<?php echo e($no); ?>" class=" form-control changesNo"                                 autocomplete="off"  step="0.01" placeholder="Fare" value="<?php echo e($value1->UmrahFare); ?>">


                            
                            <td>
                               <input type="number" name="Total[]" id="Total_<?php echo e($no); ?>" class=" form-control changesNo "
                                autocomplete="off"  step="0.01" placeholder="Total" value="<?php echo e($value1->Total); ?>">
                            ...
                            <td>
                             <input type="number" name="Paid[]" id="Paid_<?php echo e($no); ?>" class=" form-control changesNo totalLinePrice"
                                autocomplete="off"  step="0.01" placeholder="Paid" value="<?php echo e($value1->Paid); ?>">

                            </td>
                          </tr>


                          <tr class="bg-light borde-1 border-light " style="height: 40px; font-weight: bolder;" id="ttt_<?php echo e($no); ?>">
                            <td></td>
                            <td>Supplier</td>
                        ...
                        <tr class="bg-light borde-1 border-light " style="height: 40px; font-weight: bolder;" id="tttt_<?php echo e($no); ?>">

                            <td></td>
                            <td> <select name="SupplierID[]" id="SupplierID_<?php echo e($no); ?>" class="form-select select2 changesNo"  
                    ...
                    <option value="<?php echo e($value->SupplierID); ?>" <?php echo e(($value->SupplierID== $value1->SupplierID) ? 'selected=selected':''); ?>><?php echo e($value->SupplierName); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                      </td>
                           ...
                           <input type="text" class="form-control"   id="Contact_<?php echo e($no); ?>" name="Contact[]" placeholder="Contact"  value="<?php echo e($value1->Contact); ?>">


                             

                          
                            <input type="text" class="form-control"   id="Passport_<?php echo e($no); ?>" name="Passport[]" placeholder="Passport" value="<?php echo e($value1->Passport); ?>">


                                        </div></td>
                            <td>    <select name="RoomType[]" id="RoomType_<?php echo e($no); ?>" class="form-select">
                                  <option value="Quad" <?php echo e(('Quad'== $value1->RoomType) ? 'selected=selected':''); ?> >Quad </option>
                                  <option value="Triple" <?php echo e(('Triple'== $value1->RoomType) ? 'selected=selected':''); ?> >Triple</option>
                                  <option value="Double" <?php echo e(('Double'== $value1->RoomType) ? 'selected=selected':''); ?> >Double</option>
                                  <option value="Sharing" <?php echo e(('Sharing'== $value1->RoomType) ? 'selected=selected':''); ?> >Sharing</option>
                                </select>
                            </td>
                            <td> <input type="number" name="VAT[]" id="VAT_<?php echo e($no); ?>" class=" form-control vat"  
                                autocomplete="off"  step="0.01" placeholder="VAT" readonly="" value="<?php echo e($value1->Taxable); ?>">
                            </td>
                            <td>  <input type="number" name="Service[]" id="Service_<?php echo e($no); ?>" class=" form-control service "
                                autocomplete="off"  step="0.01" placeholder="Service"  readonly="" value="<?php echo e($value1->Service); ?>">
                            </td>
                            <td>  <input type="number" name="PaymentInBus[]" id="PaymentInBus_<?php echo e($no); ?>"  
                                class=" form-control changesNo" autocomplete="off"
                                step="0.01" placeholder="Payment in bus" value="<?php echo e($value1->PaymentInBus); ?>">
                            </td>
                            <td><input type="Date" name="DepartureDate[]" value="<?php echo e($value1->DepartureDate); ?>" class="form-control"></td>
                          </tr>
                            ...
                            <td>
                              ...
                              <div class="mt-2 mb-3">
                            <label for="PassportFile_1" class="fw-bolder">Passport </label> <i class="mdi mdi-trash-can-outline text-danger"  style="font-size: 16pt;float:right;margin-top:-7px;" onclick="removepicture('PassportFile_Old_',<?php echo e($no); ?>);"></i>

                            <input type="file" class="form-control"  name="PassportFile[]" id="PassportFile_1">
                            <input type="hidden" class="form-control"  name="PassportFile_Old[]" id="PassportFile_Old_<?php echo e($no); ?>" value="<?php echo e($value1->PassportFile); ?>">
                            
                            <br>
                          <?php if($value1->PassportFile): ?>
    <?php
    ...
    <?php if($extension === 'jpg' || $extension === 'jpeg' || $extension === 'png'): ?>
        ...
        <img src="<?php echo e(asset('/').$value1->PassportFile); ?>" class="rounded avatar-sm" width="50px" height="50px" 
             onclick="openImageModal('<?php echo e(asset('/').$value1->PassportFile); ?>')" id="placeholder_PassportFile_Old_<?php echo e($no); ?>">
    
    <?php elseif($extension === 'pdf'): ?>
        <!-- Display the PDF icon with a link to open the PDF in a new tab -->
        <a href="<?php echo e(asset('/').$value1->PassportFile); ?>" target="_blank">
            <img src="<?php echo e(asset('/pdf_icon.jpg')); ?>" class="rounded avatar-sm"  id="placeholder_PassportFile_Old_<?php echo e($no); ?>">
        </a>
    
    <?php else: ?>
        <!-- If the file exists but is not an image or PDF, show a placeholder or handle it accordingly -->
        <img src="<?php echo e(asset('/placeholder.jpg')); ?>" class="rounded avatar-sm" width="50px" height="50px" id="placeholder_PassportFile_Old_<?php echo e($no); ?>">
    <?php endif; ?>
...
<?php endif; ?>
                            ...
                            <i class="mdi mdi-trash-can-outline text-danger" style="font-size: 16pt;float:right;margin-top:-7px;" onclick="removepicture('EmirateIDFileFront_Old_',<?php echo e($no); ?>);"></i>
                            <input type="file" class="form-control"  name="EmirateIDFileFront[]" id="EmirateIDFileFront_1">
                          <input type="hidden" class="form-control"  name="EmirateIDFileFront_Old[]" value="<?php echo e($value1->EmirateIDFileFront); ?>" id="EmirateIDFileFront_Old_<?php echo e($no); ?>">

                              <br>
                       <!--      <?php if($value1->EmirateIDFileFront): ?>
                            <img src="<?php echo e(asset('/').$value1->EmirateIDFileFront); ?>" class="rounded avatar-sm"  width="50px" height="50px" onclick="openImageModal('<?php echo e(asset('/').$value1->EmirateIDFileFront); ?>')" id="placeholder_EmirateIDFileFront_Old_<?php echo e($no); ?>">
                            <?php else: ?>
                            <img src="<?php echo e(asset('/placeholder.jpg')); ?>" class="rounded avatar-sm"  width="50px" height="50px" id="placeholder_EmirateIDFileFront_Old_<?php echo e($no); ?>">
                            <?php endif; ?>
 -->
    ...
    <?php if($extension === 'jpg' || $extension === 'jpeg' || $extension === 'png'): ?>
        <!-- Display the image file (jpg, png) -->
        <img src="<?php echo e(asset('/').$value1->EmirateIDFileFront); ?>" class="rounded avatar-sm" width="50px" height="50px" 
             onclick="openImageModal('<?php echo e(asset('/').$value1->EmirateIDFileFront); ?>')" id="placeholder_EmirateIDFileFront_Old_<?php echo e($no); ?>">
    
    <?php elseif($extension === 'pdf'): ?>
        <!-- Display the PDF icon with a link to open the PDF in a new tab -->
        <a href="<?php echo e(asset('/').$value1->EmirateIDFileFront); ?>" target="_blank">
            <img src="<?php echo e(asset('/pdf_icon.jpg')); ?>" class="rounded avatar-sm"  id="placeholder_EmirateIDFileFront_Old_<?php echo e($no); ?>">
        </a>
...
<?php endif; ?>
                            ...
                            <i class="mdi mdi-trash-can-outline text-danger" style="font-size: 16pt;float:right;margin-top:-7px;" onclick="removepicture('EmirateIDFileBack_Old_',<?php echo e($no); ?>);"></i>
                            <input type="file" class="form-control"  name="EmirateIDFileBack[]" id="EmirateIDFileBack_1">
                            <input type="hidden" class="form-control"  name="EmirateIDFileBack_Old[]" value="<?php echo e($value1->EmirateIDFileBack); ?>" id="EmirateIDFileBack_Old_<?php echo e($no); ?>">

                              <br>
                        <!--     <?php if($value1->EmirateIDFileBack): ?>
                            <img src="<?php echo e(asset('/').$value1->EmirateIDFileBack); ?>" class="rounded avatar-sm"  width="50px" height="50px" onclick="openImageModal('<?php echo e(asset('/').$value1->EmirateIDFileBack); ?>')"  id="placeholder_EmirateIDFileBack_Old_<?php echo e($no); ?>">
                            <?php else: ?>
                            <img src="<?php echo e(asset('/placeholder.jpg')); ?>" class="rounded avatar-sm"  width="50px" height="50px"  id="placeholder_EmirateIDFileBack_Old_<?php echo e($no); ?>">
                            <?php endif; ?> -->
    ...
    <?php if($extension === 'jpg' || $extension === 'jpeg' || $extension === 'png'): ?>
        <!-- Display the image file (jpg, png) -->
        <img src="<?php echo e(asset('/').$value1->EmirateIDFileBack); ?>" class="rounded avatar-sm" width="50px" height="50px" 
             onclick="openImageModal('<?php echo e(asset('/').$value1->EmirateIDFileBack); ?>')" id="placeholder_EmirateIDFileBack_Old_<?php echo e($no); ?>">
    
    <?php elseif($extension === 'pdf'): ?>
        <!-- Display the PDF icon with a link to open the PDF in a new tab -->
        <a href="<?php echo e(asset('/').$value1->EmirateIDFileBack); ?>" target="_blank">
            <img src="<?php echo e(asset('/pdf_icon.jpg')); ?>" class="rounded avatar-sm"  id="placeholder_EmirateIDFileBack_Old_<?php echo e($no); ?>">
        </a>
...
<?php endif; ?>
                            ...
                            <i class="mdi mdi-trash-can-outline text-danger" style="font-size: 16pt;float:right;margin-top:-7px;" onclick="removepicture('PictureFile_Old_',<?php echo e($no); ?>);"></i>

                            <input type="file" class="form-control"  name="PictureFile[]" id="PictureFile_1">
                            <input type="hidden" class="form-control"  name="PictureFile_Old[]" value="<?php echo e($value1->PictureFile); ?>" id="PictureFile_Old_<?php echo e($no); ?>">

                              <br>
                       <!--      <?php if($value1->PictureFile): ?>
                            <img src="<?php echo e(asset('/').$value1->PictureFile); ?>" class="rounded avatar-sm"    width="50px" height="50px" onclick="openImageModal('<?php echo e(asset('/').$value1->PictureFile); ?>')"  id="placeholder_PictureFile_Old_<?php echo e($no); ?>">
                            <?php else: ?>
                            <img src="<?php echo e(asset('/placeholder.jpg')); ?>" class="rounded avatar-sm"  width="50px" height="50px" id="placeholder_PictureFile_Old_<?php echo e($no); ?>">
                            <?php endif; ?> -->
    ...
    <?php if($extension === 'jpg' || $extension === 'jpeg' || $extension === 'png'): ?>
        <!-- Display the image file (jpg, png) -->
        <img src="<?php echo e(asset('/').$value1->PictureFile); ?>" class="rounded avatar-sm" width="50px" height="50px" 
             onclick="openImageModal('<?php echo e(asset('/').$value1->PictureFile); ?>')" id="placeholder_PictureFile_Old_<?php echo e($no); ?>">
    
    <?php elseif($extension === 'pdf'): ?>
        <!-- Display the PDF icon with a link to open the PDF in a new tab -->
        <a href="<?php echo e(asset('/').$value1->PictureFile); ?>" target="_blank">
            <img src="<?php echo e(asset('/pdf_icon.jpg')); ?>" class="rounded avatar-sm"  id="placeholder_PictureFile_Old_<?php echo e($no); ?>">
        </a>
...
<?php endif; ?>
                            ...
                            <td style="vertical-align: top;">
                              ...
                              <input type="number" name="deduction[]" id="deduction_<?php echo e($no); ?>" class="form-control changesNo" onblur="this.readonly=true;" value="<?php echo e($value1->Deduction); ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8 col-12  ">
                      ...
                      <textarea class="form-control" rows='5' name="remarks" id="notes"
                        placeholder="Your Notes"><?php echo e($invoice_mst[0]->Note); ?></textarea>
                        ...
                        if($invoice_mst[0]->Document)
                        {
                          ...
                          <a href="<?php echo e(asset('/').$invoice_mst[0]->Document); ?>" target="_blank" class="btn btn-light">Downlaod File</a>
                          ...
                          <div class="input-group">
                            <span class="input-group-text bg-light"><?php echo e(env('APP_CURRENCY')); ?></span>
                             <input type="number" class="form-control" id="amountPaid" name="amountPaid"
                              ...
                              onpaste="return false;" step="0.01" value="<?php echo e($invoice_mst[0]->Paid); ?>">
                        ...
                        <div class="form-group mt-1 d-none">
                          ...
                          <div class="input-group">
                            ...
                            <input type="number" class="form-control amountDue" name="amountDue" id="amountDue"
                              ...
                              onpaste="return false;" step="0.01" value="<?php echo e($invoice_mst[0]->Balance); ?>">
                          </div>
                        </div>
...
function removepicture(location,id)
{
 ...
 if (confirm('Deleting picture ')) 
 {
  ...
  $('#placeholder_'+location+id).attr('src', "<?php echo e(URL('/placeholder.jpg')); ?>");
       ...
       <thead>
             ...
             <thead>
                        ...
                        <tr class="bg-light borde-1 border-light " style="height: 40px; font-weight: bolder;" id="tttt_${i}">
                            ...
                            <input type="hidden" class="form-control"  name="PassportFile_Old[]" id="PassportFile_Old_${i}" value="<?php echo e($value1->PassportFile); ?>">
                            </div>
                            ...
                            <input type="hidden" class="form-control"  name="EmirateIDFileFront_Old[]" value="<?php echo e($value1->EmirateIDFileFront); ?>" id="EmirateIDFileFront_Old_${i}">
                            </div>
                            ...
                            <input type="file" class="form-control"  name="EmirateIDFileBack[]" id="EmirateIDFileBack_${i}">
                             <input type="hidden" class="form-control"  name="EmirateIDFileBack_Old[]" value="<?php echo e($value1->EmirateIDFileBack); ?>" id="EmirateIDFileBack_Old_${i}">
                            </div>
                            ...
                            <input type="hidden" class="form-control"  name="PictureFile_Old[]" value="<?php echo e($value1->PictureFile); ?>" id="PictureFile_Old_${i}">
                            </div>
...
<!-- <script>
    $('#umrahForm').on('submit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(URL('/UmrahUpdate')); ?>",
            dataType: 'json',
            contentType: false,
            processData: false,
            cache: false,
...
<!-- <script>
  $(document).ready(function() {
      $('#PartyID').select2({
          ...
          ajax: {
              url: '<?php echo e(URL("/search-party")); ?>',
              dataType: 'json',
...
<script>
    ...
    function uploadFile(formData) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(URL('/UmrahUpdate')); ?>", // Your original file upload route
            dataType: 'json',
            contentType: false,
            processData: false,
            cache: false,
...
<?php echo $__env->make('tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/bin_javed_pk/resources/views/umrah/umrah_edit.blade.php ENDPATH**/ ?>